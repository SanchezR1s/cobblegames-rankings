...
import type { DuelPlayerStats } from "@/lib/api";
import { formatPercent, formatNumber, getTierInfo } from "@/lib/utils";
...
export default function DuelsTable({ players, offset = 0 }: DuelsTableProps) {
  return (
      ...
      <table className="w-full text-sm">
        <thead>
          <tr className="border-b border-bg-border text-gray-500 text-xs uppercase tracking-wider">
            ...
            <th className="text-right px-4 py-3 hidden sm:table-cell">Derrotas</th>
            <th className="text-right px-4 py-3 hidden md:table-cell">Win%</th>
            <th className="text-right px-4 py-3 hidden lg:table-cell">Mejor Racha</th>
          </tr>
        </thead>
